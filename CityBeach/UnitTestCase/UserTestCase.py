...
class UserTestCase(unittest.TestCase):
    ...
    def test_edit_user(self):
        ...
        login = self.user_controller.login(username="admin", password="password")   #current User = admin
        ...
        success = self.user_controller.register(data=dataMarioRossi,password="")
        self.assertTrue(success)
        success,status = self.user_controller.edit_user(user_id=self.user_controller.user_id,new_name="Mario",
    ...
    def test_delete_user(self):
        ...
        self.user_controller.login(username="admin", password="password")   #current User = admin
        dataMarioRossi =  {
            "name": "Mario",
            "surname": "Rossi",
            "username": "mRossi",
        ...
        self.user_controller.register(data=dataMarioRossi,password="")

        success = self.user_controller.delete_user(self.user_controller.get_user_by_username("mRossi"))
        self.assertTrue(success)
