...
def main_ui_layout() -> QVBoxLayout() and QPushButton()and QPushButton()and QPushButton()and QPushButton()and QLabel()and QPushButton()and QPushButton():
    ...
    #pixmap = QPixmap(image_path("Baby.tux.sit-800x800.png"))
    #scaled_pixmap = pixmap.scaled(btn_campi.size(), Qt.AspectRatioMode.KeepAspectRatio, Qt.TransformationMode.SmoothTransformation)
    #btn_campi.setIcon(QIcon(scaled_pixmap))
    #btn_campi.setIconSize(scaled_pixmap.size())
