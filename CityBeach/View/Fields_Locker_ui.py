...
def view_fields_lockers_static_ui_layout(field_list: List[Field], locker_list: List[Locker]):
    ...
    del_field_btn.setFixedWidth(200)
    ...
    add_lock_btn = QPushButton("Crea Spog.")
    ...
    del_lock_btn.setFixedWidth(200)
